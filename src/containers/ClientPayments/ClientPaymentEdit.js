...
class ClientPaymentEdit extends Component {
  constructor(props) {
    super(props);

    this.state = {
      clientPaymentId: undefined,
      clientId: undefined,
      clientName: "",
  ...
  componentDidMount() {
    axios
      .get("/clientpayment/" + this.props.match.params.clientPaymentId)
      .then(response => {
        axios
          .get("/paymenttype/all")
          .then(result => {
            this.setState({
              clientPaymentId: response.data.clientPaymentId,
              ...
              paymentTypeId: response.data.paymentType.paymentTypeId,
  ...
  onSavePayment = event => {
    ...
    let data = {
      clientPaymentId: this.state.clientPaymentId,
